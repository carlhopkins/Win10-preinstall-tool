# Windows 10 Debloat Script - Full Edition 2.1.0 - Copyright (c) 2022 Carl Hopkins
...
# Init
Write-Host "+===================================================+"
Write-Host ".  Windows 10 Debloat Shell - Full Edition 2.1.0    ."
Write-Host "+===================================================+"
Write-Host ""
...
$Form.text                    = "Windows 10 De-Bloat - Full Edition 2.1.0"
...
$ooshutup.width                  = 205
$ooshutup.height                 = 70
$ooshutup.location               = New-Object System.Drawing.Point(5,90)
...
$actioncenter.location           = New-Object System.Drawing.Point(5,290)
...
$Panel4.height                   = 65
$Panel4.width                    = 730
$Panel4.location                 = New-Object System.Drawing.Point(20,460)
...
$Panel2.controls.AddRange(@($essentialtweaks,$ooshutup,$windowssearch,$backgroundapps,$cortana,$removebloat,$actioncenter,$STrayIcons))
